  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="#who">QUI?</a></li>
        <li><a href="#whofor">POUR QUI?</a></li> 
        <li><a href="#guitares">GUITARES</a></li>
        <li><a href="#micros">MICROS</a></li>
        <li><a href="#batteries">BATTERIES</a></li>
        <li><a href="#contact">CONTACT</a></li>       
        <li id="log-in"><a href="#" data-toggle="modal" data-target="#loginModal">CONNEXION</a></li>
        <li id="userInfos" style="display:none"><a href="#" data-toggle="modal" data-target="#userInfoModal">Informations utilisateur</a></li>
        <li id="log-out" style="display:none"><a href="#" data-toggle="modal" data-target="#logoutModal">DÉCONNEXION</a></li>        
